...
import { field } from "@/animations/form";
...
function Form() {
	...
	return (
		<motion.form onSubmit={handleSubmit} className="space-y-6" initial="hidden" animate="visible">
			<motion.div variants={field} initial="hidden" animate="visible" transition={{ delay: 0.1 }}>
			...
			<motion.div variants={field} initial="hidden" animate="visible" transition={{ delay: 0.2 }}>
			...
			<motion.div variants={field} initial="hidden" animate="visible" transition={{ delay: 0.3 }}>
			...
			<motion.div variants={field} initial="hidden" animate="visible" transition={{ delay: 0.4 }}>
